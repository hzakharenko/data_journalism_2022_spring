...
**A2** Kanawha got the most loans, which was 4273 loans.
...
**A3** Palm Beach got the fewest laons, which was only 2 loans.
...
**A4** I think that the loans listed in Palm Beach were a mistake because there is no Palm Beach county in West Virginia, but there is a Palm Beach in Florida. This may have been a mistake made during data entry.
...
**A5** Greenbrier Hotel Corporation got the state's largest PPP loan. It was $8,912,202. This business is a historical landmark and resort. The data says that the loan retained 500 jobs.
...
**A6** Jim Justice, the governor of West Virginia, owns Greenbrier Hotel Corporation. Source: https://www.propublica.org/article/west-virginia-greenbrier-governor-jim-justice-little-trump
...
**A7** The minimum loan amount in the state was only $165, and the maximum loan amount in the state was 8,912,202 dollars. There were 33,336 loans given in the state, amounting to 2,600,771,578 dollars. The mean loan amount was 78,016.91 dollars, while the median loan amount was only 20,832 dollars. 
```{r}
