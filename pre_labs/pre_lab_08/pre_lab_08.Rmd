...
#removed key for publish to Github after finishing pre-lab
```
...
**Answer**The state with the lagest percentage growth was Nevada. 
...
**Answer** No, the difference is not significant.

Is the difference between Howard and everyone else significant?
**Answer** The difference between Howard and everyone else is significant.
...
**Answer**Somerset County and Caroline County saw their median incomes fall from  2010-2019. The change is not outside the margin of error for both.
...
**Answer** Of the top 20 zip codes with the largest amounts, zip codes 21202, 21740 and 21201 had an estimated medial household income of less than $50,000.
